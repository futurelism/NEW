...
class BaseExecutionTimePredictor(ABC):
    ...
    def _get_image_projection_execution_time(self, batch: Batch) -> float:
    # 添加图像投影层时间预测方法
        pass

    def _get_text_projection_execution_time(self, batch: Batch) -> float:
    # 添加文本投影层时间预测方法
        pass

    def _get_contrastive_similarity_execution_time(self, batch: Batch) -> float:
    # 添加计算相似度矩阵的时间预测方法
        pass
